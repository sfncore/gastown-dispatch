...
function QueueLevel({ pending, inFlight, blocked, max = 20, label, isRigActive = false }: {
	...
	return (
		<div className={cn("flex flex-col items-center flex-shrink-0", !isRigActive && "opacity-50")}>
			<div className={cn(
				"text-[8px] sm:text-[9px] md:text-[10px] lg:text-[11px] xl:text-xs uppercase mb-1.5 sm:mb-2 lg:mb-2.5 font-bold tracking-wide text-center max-w-[50px] sm:max-w-[60px] md:max-w-[70px] lg:max-w-[85px] xl:max-w-[100px] truncate",
			...
			<div className="relative">
				...
				<div className="w-12 sm:w-16 md:w-18 lg:w-20 xl:w-24 h-3 sm:h-3.5 md:h-4 lg:h-4.5 xl:h-5 relative">
				...
				{/* Main silo body */}
				<div className={cn(
					"relative w-12 sm:w-16 md:w-18 lg:w-20 xl:w-24 h-20 sm:h-24 md:h-28 lg:h-32 xl:h-36 border-2 rounded-b-lg overflow-hidden",
			...
			{/* Stats readout */}
			<div className="mt-1.5 sm:mt-2 lg:mt-2.5 xl:mt-3 text-center">
				<div className="font-mono text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold text-slate-200">{total}</div>
				<div className="flex gap-1 sm:gap-1.5 md:gap-2 text-[7px] sm:text-[8px] md:text-[9px] lg:text-[10px] xl:text-[11px] justify-center font-mono">
						...
						<div className="bg-slate-900/60 border border-slate-700 rounded-lg p-4 flex-1 overflow-hidden flex flex-col">
							...
							<div className="overflow-y-auto flex-1">
								{sortedRigs.length === 0 ? (
									...
									<div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-7 xl:grid-cols-8 gap-3 sm:gap-4 md:gap-5 lg:gap-6 xl:gap-8 justify-items-center">
